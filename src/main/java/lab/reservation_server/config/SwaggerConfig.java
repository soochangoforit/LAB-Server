package lab.reservation_server.config;
...
public class SwaggerConfig {
    ...
    private static final Contact DEFAULT_CONTACT = new Contact("이수찬", "http://www.deu.lab.com", "tncksdl05@gmail.com");
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("lab.reservation_server.controller"))
